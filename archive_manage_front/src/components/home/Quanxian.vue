<template>
    ...
    <div style="position: fixed;top:150px;left:230px">
        <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="jiekou" label="接口" width="200" />
    ...
    <el-dialog :model-value="status" @close="status = false">
        <el-form :model="form" label-width="120px" ref="formRef">
            ...
            <el-form-item label="接口" required prop="jiekou">
                <el-input v-model="form.jiekou" />
            </el-form-item>
            <el-form-item>
